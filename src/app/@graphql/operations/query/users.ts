...
export const USERS_LIST_QUERY = gql`
  query userList($page: Int, $itemsPage: Int, $active: ActiveFilterEnum, $filterName: String, $include: Boolean!) {
    users(page: $page, itemsPage: $itemsPage, active: $active, filterName: $filterName) {
      info {
        ...ResultInfoObject
      }
      status
